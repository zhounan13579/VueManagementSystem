<template>
  <div class="user">
    ...
    <div class="content">
      <!-- pageUrlName="users" -->
      <!-- ref="pageContentRef"是为了拿到page-content里面搜索框里面的数据 -->
      <page-content
        ref="pageContentRef"
...
export default defineComponent({
  ...
  setup() {
    ...
    // }
    // 2、下面是从hooks里面拿的东西。也可以直接在return里面写...usePageSearch()，但是这样阅读性太差
